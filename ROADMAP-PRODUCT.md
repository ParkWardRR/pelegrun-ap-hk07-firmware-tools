...
Status: ✅ done · 🟡 in progress · ⬜ planned. Current release: **v0.4.0**.
...
**Phases 1–8 and 11 are shipped** (all six dev-roadmap phases complete — see
[ROADMAP-DEV.md](ROADMAP-DEV.md)). Remaining product surface: fleet batch/canary
automation (P9), the supported FIT real-serial adoption path (P10), and adapters
for Senao boards beyond `ap-hk07` (P12).
